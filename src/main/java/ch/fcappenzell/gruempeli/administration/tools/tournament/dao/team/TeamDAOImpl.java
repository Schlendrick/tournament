...
import ch.fcappenzell.gruempeli.administration.tools.tournament.model.team.TeamMapperSimple;
...
public class TeamDAOImpl implements TeamDAO {
    ...
    private final String SQL_GET_ALL_ADDRESS = "select * from T_Adressen";
    ...
    public List<Team> getAllAddress() {
        return jdbcTemplate.query(SQL_GET_ALL_ADDRESS, new TeamMapper());
    }

    public Map<Long, Team> getAllTeamsMap() {
        Map<Long, Team> map = jdbcTemplate.query(SQL_GET_ALL, new TeamMapperSimple()).stream()
